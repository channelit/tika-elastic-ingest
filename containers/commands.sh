...
docker run -it --name=es -v $(PWD)/elastic/config:/usr/share/elasticsearch/config -v $(PWD)/elastic/data:/usr/share/elasticsearch/data -v $(pwd)/elastic/logs:/usr/share/elasticsearch/logs -p 9200:9200 -p 9300:9300 elasticsearch
